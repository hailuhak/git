...
>
  <div className="p-6 w-full max-w-lg mx-auto"> {/* decreased width */}
    ...
    />
      ...
      {/* Dates Horizontal on desktop, stacked on mobile */}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <DatePicker
            ...
            onChange={(date: Date | null) => {
              ...
              if (editingCourse) {
                const adjustedEnd =
                  editingCourse.endDate && editingCourse.endDate < date
                    ? date
                    : editingCourse.endDate;
                setEditingCourse({ ...editingCourse, startDate: date, endDate: adjustedEnd });
              } else {
                const adjustedEnd =
                  newCourse.endDate && newCourse.endDate < date ? date : newCourse.endDate;
