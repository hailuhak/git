...
export default function Session() {
  ...
  const handleSaveSession = async () => {
    ...
    setNewSession({ regStart: "", regEnd: "", trainStart: "", trainEnd: "" });
    setEditingId(null);
    setShowForm(false);
    fetchSessions();
  };
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSession({ ...newSession, regStart: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSession({ ...newSession, regEnd: e.target.value })
                  }
                  className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600"
                />
                {errors.regEnd && (
                  <p className="text-xs text-red-500 mt-1">{errors.regEnd}</p>
                )}
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSession({ ...newSession, trainStart: e.target.value })
                  }
                  className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600"
                />
                {errors.trainStart && (
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSession({ ...newSession, trainEnd: e.target.value })
                  }
                  className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600"
                />
                {errors.trainEnd && (
                  <p className="text-xs text-red-500 mt-1">{errors.trainEnd}</p>
                )}
              </div>
            </div>
          ...
          <table className="w-full text-sm border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
              <tr>
                ...
                <th className="px-4 py-2 text-center border border-gray-200 dark:border-gray-700">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody>
              {sessions.map((s) => (
                ...
                >
                  <td className="px-4 py-2 border border-gray-200 dark:border-gray-700 font-medium text-gray-800 dark:text-gray-100">
                    {s.title}
                  </td>
