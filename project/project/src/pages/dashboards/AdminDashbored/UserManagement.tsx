...
export const UserManagement: React.FC = () => {
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      // Build user object (pending by default in users)
      const userData: User = {
        uid,
        displayName,
        email,
      ...
      // Save chosen role separately for admin approval
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      // If the current user updates their own email → update Firebase Auth
